	...
	protected void onDraw(Canvas canvas) {
		...
		*/
		...
		if (MyApplication.intColorScreen == MyApplication.SCREEN_BLUE || MyApplication.intColorScreen == MyApplication.SCREEN_KTVUI) {
			...
			if((MyApplication.intSvrModel == MyApplication.SONCA_SMARTK && song.isYoutubeSong()) || 
					(MyApplication.intSvrModel == MyApplication.SONCA_SMARTK && MyApplication.flagSmartK_801 
		...
		if (MyApplication.intColorScreen == MyApplication.SCREEN_BLUE || MyApplication.intColorScreen == MyApplication.SCREEN_KTVUI) {
			...
			if (MyApplication.intWifiRemote == MyApplication.SONCA) {
				...
				if(MyApplication.intSvrModel == MyApplication.SONCA_SMARTK && song.isYoutubeSong()){
				...
				} else if(MyApplication.intSvrModel == MyApplication.SONCA_SMARTK && MyApplication.flagSmartK_801 
						&& song.isOfflineSong() == false){
					...
					if (MyApplication.bOffFirst == true) {
						if (isTouch) {
							if (drawHover != null) {
								drawHover.setBounds((int) (CircleX - FR), (int) (CircleX - FR), (int) (CircleX + FR), (int) (CircleX + FR));
								drawHover.draw(canvas);
							}
						} else {
							if (isActive) {
								if (drawActive != null) {
									drawActive.setBounds((int) (CircleX - FR), (int) (CircleX - FR), (int) (CircleX + FR), (int) (CircleX + FR));
									drawActive.draw(canvas);
								}
							} else {
								if (drawInActive != null) {
									drawInActive.setBounds((int) (CircleX - FR), (int) (CircleX - FR), (int) (CircleX + FR), (int) (CircleX + FR));
									drawInActive.draw(canvas);
								}
							}
						}
					} else {
						drawFirstXam.setBounds((int) (CircleX - FR), (int) (CircleX - FR), (int) (CircleX + FR), (int) (CircleX + FR));
						drawFirstXam.draw(canvas);
					}
