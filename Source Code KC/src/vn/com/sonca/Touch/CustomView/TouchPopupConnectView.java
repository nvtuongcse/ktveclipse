...
public class TouchPopupConnectView extends View {
	...
	private void initView(Context context) {
		...
		if(KTVNEWUI){
			drawBackGround = getResources().getDrawable(R.drawable.bg_dialog);
			butActive = getResources().getDrawable(R.drawable.bnt_hover);
			butInActive = getResources().getDrawable(R.drawable.bnt);
	...
	protected void onDraw(Canvas canvas) {
		...
		if (MyApplication.intColorScreen == MyApplication.SCREEN_BLUE || MyApplication.intColorScreen == MyApplication.SCREEN_KTVUI) {
			...
			textPaint.setColor(Color.parseColor("#902E00"));
			textPaint.setTextSize(textB1S);
