...
public class FragmentYouTube extends FragmentBase implements OnMainListener {
	...
	private TextView tv1,tv2,tv3,tv4,tv6,tv5;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		tv1= (TextView) view.findViewById(R.id.tvThongBao1);
		tv1.setTextColor(Color.WHITE);
		tv2 = (TextView) view.findViewById(R.id.tvThongBao2);
		tv2.setTextColor(Color.WHITE);
		tv3= (TextView) view.findViewById(R.id.tvThongBao3);
		tv3.setTextColor(Color.WHITE);
		tv4 = (TextView) view.findViewById(R.id.tvThongBao4);
		tv4.setTextColor(Color.WHITE);
		tv5= (TextView) view.findViewById(R.id.tvThongBao5);
		tv5.setTextColor(Color.WHITE);
		tv6 = (TextView) view.findViewById(R.id.tvThongBao6);
...
//	private boolean flagFreshData = false;
	...
	private void updateData(int idx) {
		...
		if (adapterData == null) {
			...
			adapterData = new AdapterYouTube(context, R.layout.item_youtube_list, listData, search, mainActivity);
			adapterData.setOnAdapterYouTubeListener(new AdapterYouTube.OnAdapterYouTubeListener() {
