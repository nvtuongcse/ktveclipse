...
/**
 * Created by tuong on 06/02/2018.
 */
...
public class FragmentSongType extends FragmentBase implements OnMainListener,OnBntFilterListener {

    private ArrayList<SongType> songTypeList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnScrollListener(new AbsListView.OnScrollListener() {
            ...
            public void onScroll(AbsListView absListView, int i, int i1, int i2) {
                ((KTVMainActivity)getActivity()).setTotal(listView.getFirstVisiblePosition()+1,-1);
            }
        });
...
//		}
        ...
        protected Integer doInBackground(Void... params) {
            try {
                ...
                if (MyApplication.mSongTypeList != null
                    ...
                    songTypeList.addAll(MyApplication.mSongTypeList);
                    return 1;
                }
    ...
    public void updateMyAdapter(int uPositon) {
        ...
        if (adapter == null) {
            adapter = new SongTypeAdapter(context, songTypeList);
            listView.setOnItemClickListener(new OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    MyLog.e("Fragmentsongtype","Onitemclicked--------");
