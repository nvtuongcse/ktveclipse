...
//        drawBackgroud = getResources().getDrawable(R.drawable.boder_search);
...
//                R.drawable.total_khung_hover);
    ...
    private vn.com.sonca.Touch.CustomView.TouchSearchView.OnSearchViewListener listener;
    ...
    public void setOnSearchViewListener(vn.com.sonca.Touch.CustomView.TouchSearchView.OnSearchViewListener listener){
        this.listener = listener;
    }

//---------------------------------------------------//
    public void setStateSearch(int stateSearch1){
        this.StateSearch1 = stateSearch1;
    ...
    public void onSearch(){
        listener.OnSearch(getState1(),getState2(),getTextSearch());
    }
    ...
    protected void onDraw(Canvas canvas) {
		...
		*/
        ...
        if(MyApplication.intColorScreen == MyApplication.SCREEN_BLUE || MyApplication.intColorScreen == MyApplication.SCREEN_KTVUI){
            color_001 = Color.argb(255, 255, 255, 0);
            color_002 = Color.argb(255, 255, 255, 0);
            color_003 = Color.argb(255, 255, 255, 0);
            color_004_b = Color.parseColor("#ffe002");;
            color_004 = Color.argb(255, 255, 255, 0);
            color_005 = Color.argb(255, 255, 255, 0);
            color_006 = Color.argb(255, 255, 255, 0);
            color_007 = Color.argb(255, 255, 255, 0);
            color_008 = Color.argb(255, 255, 255, 0);
            color_009 = Color.argb(255, 255, 255, 0);
            color_010 = Color.WHITE;
...
//                        canvas.drawText(textHint , KTSearch , KTY1 , mainPaint);
                        ...
                        mainPaint.setColor(color_001);
                        canvas.drawText(textSearch, KTSearch - mainPaint.measureText(textSearch+"|")/2 , KTY1, mainPaint);
                    }
                    if(isActiveSearch){
                        mainPaint.setColor(color_010);
                        canvas.drawLine(KTSearch + mainPaint.measureText(textSearch)/2 , KLY1 , KTSearch + mainPaint.measureText(textSearch)/2 , KLY2 , mainPaint);
                    }
...
//                                (KR4L + KR4R)/2 - lengthText/2 , (float) ((KR3T + KR3B)/2 + KS2/2.5) , mainPaint);
                ...
                case SONG : {
                    if(TouchMainActivity.SAVETYPE == TouchMainActivity.SONG
                            && MyApplication.intSvrModel == MyApplication.SONCA_SMARTK && MyApplication.flagSmartK_801 == false
...
//                                (KR4L + KR4R)/2 - lengthText/2 , (float) ((KR3T + KR3B)/2 + KS2/2.5) , mainPaint);
                ...
                case PLAYLIST : {
                    mainPaint.setStyle(Style.FILL);
                    mainPaint.setARGB(255, 255, 254, 255);
...
//                    canvas.drawRect((float) (KR1L) , (float) (KR1T) , (float) (KR1R) ,(float) (KR1B) , mainPaint);
                    ...
                    if(isActiveSearch){
                        mainPaint.setColor(color_010);
                        canvas.drawLine(KD1L + mainPaint.measureText(textSearch)/2 , KLY1 , mainPaint.measureText(textSearch)/2 , KLY2 , mainPaint);
                    }
...
////////////////////////// - POINTER - /////////////////////////////////
    ...
    private float getPointerText(float offsetX , float offset0 , float textSize , String text){
        ...
        float maxOffset = - paint.measureText(text)/2 + offset0;
        float out = 0;
        if(offsetX <= offset0){
            out = offset0;
            positionT = 0;
        ...
        return - paint.measureText(text)/2 + offset0;
    }
