package vn.com.sonca.newUI.modal.view.drawer;
...
public class ListDeviceView extends View {
    ...
    public ListDeviceView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initView(context);
    }

    public ListDeviceView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView(context);
    }

    private vn.com.sonca.Touch.CustomView.TouchListDeviceView.OnListDeviceView listener;
    ...
    public void setOnListDeviceViewListener(vn.com.sonca.Touch.CustomView.TouchListDeviceView.OnListDeviceView listener){
    ...
    private void initView(Context context) {
        if(KTVNEWUI) {
            drawUSB = getResources().getDrawable(R.drawable.qanli);
            drawUSBIN = getResources().getDrawable(R.drawable.qanli);
            drawIN = getResources().getDrawable(R.drawable.bnt_act_connect);
            drawAC = getResources().getDrawable(R.drawable.bnt_hover_connect);
            drawAddAC = getResources().getDrawable(R.drawable.add);
            drawAddHO = getResources().getDrawable(R.drawable.add);
            drawRefreshAC = getResources().getDrawable(R.drawable.scan);
            drawRefreshHO = getResources().getDrawable(R.drawable.scan);
            drawWifi = getResources().getDrawable(R.drawable.setwwifi);
            drawBack = getResources().getDrawable(R.drawable.connect_back_48x48);
            textLabel = getResources().getString(R.string.connect_0);
            drawBack = getResources().getDrawable(R.drawable.connect_back_48x48);
            drawChange = getResources().getDrawable(R.drawable.helo);
            drawChangeXam = getResources().getDrawable(R.drawable.helo);
            drawNO = getResources().getDrawable(R.drawable.bnt_inact_connect);
            drawOffUserOn = getResources().getDrawable(R.drawable.user);
            drawOffUserOff = getResources().getDrawable(R.drawable.user);
            drawOffUserXam = getResources().getDrawable(R.drawable.user);
            drawBlock = getResources().getDrawable(R.drawable.block);
            drawBlockXam = getResources().getDrawable(R.drawable.block);
            drawSelectList = getResources().getDrawable(R.drawable.lisstsong);
            drawSelectListXam = getResources().getDrawable(R.drawable.lisstsong);
            drawLanguege = getResources().getDrawable(R.drawable.qanli);
            drawSleep = getResources().getDrawable(R.drawable.manhinh);

            drawOffUserOn_mp4 = getResources().getDrawable(R.drawable.user);
            drawOffUserOff_mp4 = getResources().getDrawable(R.drawable.user);
            drawOffUserXam1 = getResources().getDrawable(R.drawable.user);
            drawOffUserXam2 = getResources().getDrawable(R.drawable.user);
