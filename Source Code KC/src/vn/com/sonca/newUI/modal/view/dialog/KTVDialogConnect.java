package vn.com.sonca.newUI.modal.view.dialog;
...
public class KTVDialogConnect extends View {
    ...
    public KTVDialogConnect(Context context) {
        super(context);
        initView(context);
    }

    public KTVDialogConnect(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initView(context);
    }

    public KTVDialogConnect(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView(context);
    }

    private vn.com.sonca.Touch.CustomView.TouchPopupConnectView.OnPopupConnectViewListener listener;
    public interface OnPopupConnectViewListener {
        public void OnNoListener();
        public void OnYesListener();
    }

    public void setOnPopupConnectViewListener(vn.com.sonca.Touch.CustomView.TouchPopupConnectView.OnPopupConnectViewListener listener){
