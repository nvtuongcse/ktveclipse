...
public class SingerView extends View {
    ...
    private vn.com.sonca.Touch.CustomView.TouchSingerView.OnSingerListener listener;
    ...
    public void setOnSingerListener(vn.com.sonca.Touch.CustomView.TouchSingerView.OnSingerListener listener){
    ...
    private void initView(Context context) {
        ...
        drawHover = getResources().getDrawable(
                R.drawable.icon_vocal_focus);
        drawActive = getResources().getDrawable(
                R.drawable.icon_vocal);
        textTitle = getResources().getString(R.string.main_left_4_1);
...
//                R.drawable.zlight_mc_vocal_off_96x96);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        textPaint.setARGB(178, 255, 255, 255);
        float w = textPaint.measureText(textTitle);
        canvas.drawText(textTitle,
                (float) (0.5 * widthLayout - 0.5 * w), titleY,
                textPaint);
