...
public class LanguageRemainItemView extends View {
	...
	public LanguageRemainItemView(Context context) {
		super(context);
		initView(context);
	}

	public LanguageRemainItemView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
		initView(context);
	}

	public LanguageRemainItemView(Context context, AttributeSet attrs, int defStyle) {
