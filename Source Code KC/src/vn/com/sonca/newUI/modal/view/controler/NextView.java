...
public class NextView extends View {
    ...
    private vn.com.sonca.Touch.CustomView.TouchNextView.OnNextListener listener;
    ...
    public void setOnNextListener(vn.com.sonca.Touch.CustomView.TouchNextView.OnNextListener listener) {
...
//		 this.context = context;
        ...
        activeBackgroundHover = getResources().getDrawable(
                R.drawable.icon_next_focus);
//		drawable = getResources().getDrawable(R.drawable.icon_next);
        drawBG = getResources().getDrawable(R.drawable.icon_next);
        ...
        zlight_drawable = getResources().getDrawable(R.drawable.zlight_mc_next_);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (MyApplication.intColorScreen == MyApplication.SCREEN_BLUE || MyApplication.intColorScreen == MyApplication.SCREEN_KTVUI || flagBigSize) { // THEME-BLUE
            ...
            if (isConnected) {
                ...
                Rect bRect = new Rect();
                mPaint.getTextBounds(text, 0, text.length(), bRect);
                canvas.drawText(text, widthLayout / 2 - bRect.width() / 2,
                        heightLayout / 2 + bRect.height() / 2 + textDY,
                        mPaint);
