...
public class ItemLanguage extends View {
...
//        first_in = context.getResources().getDrawable(R.drawable.first_hover);
    ...
    public ItemLanguage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ItemLanguage(Context context, AttributeSet attrs, int defStyleAttr) {
