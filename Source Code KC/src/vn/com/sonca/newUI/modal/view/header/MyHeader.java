...
public class MyHeader extends View {
    ...
    private String title = TabViewIcon.SONG;
    private int textS;
...
//        drawLine = getResources().getDrawable(R.drawable.shape_line_search_view);
    ...
    private vn.com.sonca.Touch.CustomView.TouchMyGroupView.OnMyGroupListener listener;
    ...
    public void setOnMyGroupListener(vn.com.sonca.Touch.CustomView.TouchMyGroupView.OnMyGroupListener listener) {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        textS = getHeight()/2;
        mainPaint.setTextSize(textS);
        mainPaint.setARGB(255,255,255,0);
        mainPaint.setTypeface(Typeface.DEFAULT_BOLD);
        canvas.drawText(title,getWidth()/2-mainPaint.measureText(title)/2,getHeight()/2 + 0.35f*textS,mainPaint);
        ...
        if (MyApplication.intColorScreen == MyApplication.SCREEN_BLUE || MyApplication.intColorScreen == MyApplication.SCREEN_KTVUI) {
            ...
            mainPaint.setColor(Color.parseColor("#00003c6e"));
...
//                drawable.draw(canvas);
                ...
                canvas.drawText(serverName, (rectList.left + rectList.right)
                ...
                if (isConnected) {
                    if (currectSong == null
                        ...
                        currectSong = cutText(KTS3, Kcut, currectSong);
                        textWidth = mainPaint.measureText(String
                                .valueOf(currectSong));
//                        canvas.drawText(currectSong, (righttLayout + K5
//                                + widthLayout - K40)
...
//                                    - textWidth / 2, KT5, mainPaint);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        rectList = new Rect((int) (0.78 * w), (int) ( h*0.001), (int) (0.999 * w), (int) (0.94 * h));
        rectLeft = new Rect((int) (0.000 * w), (int) (0), (int) (0.21 * w), (int) (0.93 * h));
...
*/
        KD2L =1660*widthLayout/1920;
        KD2R = (1660 + 104) * widthLayout / 1920;
        ...
        KD5L =1 - (105 - 25) * widthLayout / 1920;
        KD5R = 105 * widthLayout / 1920;
        KD5T =1 - (120 - 30) * heightLayout / 184;
