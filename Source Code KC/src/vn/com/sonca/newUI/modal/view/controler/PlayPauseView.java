...
public class PlayPauseView extends View {
    ...
    private vn.com.sonca.Touch.CustomView.TouchPauseView.OnPauseListener listener;
    ...
    public void setOnPauseListener(vn.com.sonca.Touch.CustomView.TouchPauseView.OnPauseListener listener) {
...
//				R.drawable.cham_boder_vuong);
        pauseDrawable = getResources().getDrawable(R.drawable.icon_pause);
        playDrawable = getResources().getDrawable(R.drawable.icon_play);
        pauseplayDrawable = getResources().getDrawable(
                R.drawable.touch_mc_pauseplay_96x96);

        drawBG = getResources().getDrawable(R.drawable.icon_play);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.getTextBounds(pauseplayText, 0, pauseplayText.length(),
                boundR);
        canvas.drawText(pauseplayText, widthLayout / 2 - boundR.width() / 2, heightLayout*0.9f , mPaint);
