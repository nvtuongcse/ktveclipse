...
//			Log.e(AppConfig.DBDebugTag, "DBGetSongTypeIDCursor"); 
	...
	public static String datamapping(Context context,int searchLength,String strsearch,FragmentBase.FragmentType searchType,int searchState,int languageID){

		dbInstance = DBInstance.getInstance(context, dbName);
		try {
			dbInstance.open();
			MyLog.e("DatabaseInterface",dbName  + " " + strsearch + " "+searchLength + " ");
			return dbInstance.keyboardmapping(searchLength,strsearch,searchType,searchState,languageID);
		}
		catch (Exception e) {
			MyLog.e("",e.toString());
		}
